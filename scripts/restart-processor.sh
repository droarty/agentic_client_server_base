...
echo "Restarting event-processor from: $(pwd)"
...
echo -n "Waiting for event-processor on :$PORT"
...
echo ""
echo "✗ event-processor did not respond within ${TIMEOUT}s — last log lines:"
