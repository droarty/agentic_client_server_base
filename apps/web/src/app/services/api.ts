...
export async function apiGetOrCreateWorkflowSession(params: { workflowType: string; groupId?: string; parentChannelId?: string; responseHandler?: string; targetArtifactId?: string }): Promise<{ channelId: string }> {
